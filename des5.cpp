...
int permChoiceOne[] = { 57, 49, 41, 33, 25, 17, 9 , 1 , 58, 50, 42, 34, 26, 18,
            10, 2 , 59, 51, 43, 35, 27, 19, 11, 3 , 60, 52, 44, 36,
            63, 55, 47, 39, 31, 23, 15, 7 , 62, 54, 46, 38, 30, 22,
            14, 6 , 61, 53, 45, 37, 29, 21, 13, 5 , 28, 20, 12, 4 };
                       
int permChoiceTwo[] = {14, 17, 11, 24, 1 , 5 , 3 , 28, 15, 6 , 21, 10, 23, 19, 12, 4 ,
...
void genKeys(string left, string right)
{
    ...
    for (int i=0; i<16; i++)
    {
        ...
        cout << "key " << i+1 << " \t: " << key << " : " << hex << bitset<48> (key).to_ulong() << endl;
        fout << key<<" : "<< hex << bitset<48> (key).to_ulong() << endl;
    }
}
